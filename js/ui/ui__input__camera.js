...
// jgson import { _default480p }         from '../utils/utils__camera.js'
...
// jgson const _lastCameraConstraints    = { width: 640, height: 480, frameRate: 30, facingMode: 'user', mirrored: true }
const _lastCameraConstraints    = { width: { ideal: 4096 }, height: { ideal: 2160 }, frameRate: 30, facingMode: 'user', mirrored: true }
...
export const openCamera = (constraints) => {
  ...
  if(!constraints) constraints = _lastCameraConstraints
