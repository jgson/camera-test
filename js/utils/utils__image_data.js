...
export const addEnterFrame = (input, canvas0, canvas1, overlayCanvas, drawFunction, onImageData, doOnlyOnce) => {
      ...
      onEnterFrame: ()        => {
		...
		if(!foundDifference) {
         ...
         // warn('no new image')
		  ...
		  ctxOverlayCanvas.clearRect(0, 0, overlayCanvas.width, overlayCanvas.height)


// jgson          onImageData(efo.activeImageData, efo.activeCanvas, efo.inactiveCanvas)
          onImageData(efo.activeImageData, overlayCanvas)
